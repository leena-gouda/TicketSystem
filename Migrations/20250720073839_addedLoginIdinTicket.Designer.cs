...
namespace TicketSystem.Migrations
{
    ...
    [Migration("20250720073839_addedLoginIdinTicket")]
    partial class addedLoginIdinTicket
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TicketSystem.Models.Caller", b =>
                {
                    b.HasOne("TicketSystem.Models.LoginModel", "Login")
                        .WithOne("caller")
                        .HasForeignKey("TicketSystem.Models.Caller", "LoginId")
            ...
            modelBuilder.Entity("TicketSystem.Models.Watcher", b =>
                {
                    b.HasOne("TicketSystem.Models.LoginModel", "Login")
                        .WithOne("watcher")
                        .HasForeignKey("TicketSystem.Models.Watcher", "LoginId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
